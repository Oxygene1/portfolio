...
export const testimonials: ProjectTypes[] = [
  ...
  },
  {
    image: lasmab,
    title: "LASMAB",
    description: "Exploring the latest Updates, Innovations and Breakthroughs in Lagos Anglican Schools",
  ...
  },
  {
    image: with_jara,
    title: "With Jara",
    description: "Sell your products online and unlock the power of withJara's growing marketplace.",
...
export   const resumeData: ResumeData = {
    ...
    summary:
      "Innovative Senior Frontend Engineer with 5+ years of experience building scalable web and mobile applications using React, React Native, and TypeScript. Proven leader in optimizing performance (60%+ efficiency gains), reducing technical debt, and mentoring teams.",
    experience: [
      {
        ...
        points: [
          "Boosted system efficiency by 60% and user satisfaction by 45% through React-based microservices architecture, cutting deployment time by 40%.",
          "Led 8 developers in building 5 high-performance apps, reducing user complaints by 45% and achieving 90% code coverage via Jest/React Testing Library.",
          "Streamlined CI/CD pipelines (Jenkins/GitLab), slashing deployment time from 45 minutes to 10 minutes.",
          "Designed a Progressive Web App (PWA) with Next.js, improving page load time by 60% and user retention by 50%.",
          "Championed TypeScript adoption, reducing runtime errors by 30%, and trained 20+ developers in advanced React patterns.",
          "AI Exploration: Explored integrating real-time data with AI-driven personalization for predictive UI features.",
        ],
      },
      {
        ...
        points: [
          "Migrated WordPress site to React/Next.js, increasing lead generation from 200 to 4,000/month (1900% growth).",
          "Architected Ulego (fintech app) using React Native and GraphQL, generating $500K revenue in the first year.",
          "Built a Learning Management System (LMS) with real-time WebSocket collaboration, reducing data sync issues by 70%.",
          "Mentored 15 interns (80% promoted to junior roles) and established coding standards, cutting technical debt by 40%.",
          "Implemented A/B testing frameworks, driving 25% higher conversion rates through UI/UX improvements.",
        ],
      },
    ],
    education: [
